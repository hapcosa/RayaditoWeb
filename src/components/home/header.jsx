                    ...
                    <div>
                        <div>
                            <h1 className="text-6xl font-bold tracking-tight sm:text-center sm:text-6xl">
                                Piedras <Typewriter words={
                                        ['de Chiloè', 'naturales', 'lapidadas a mano', ]
                                    }
                                    loop={0}
                                    cursor
                                    cursorStyle='_'
                            ...
                            <ul className='flex gap-4'>
                                <li className='hover:animate-pulse text-lg inline-flex font-semibold leading-6 text-gray-600 hover:text-gray-500 border-b-2 transition duration-800  border-white hover:border-gray-400 '>
                                    <Link to="/joyas">Joyas</Link>
                                </li>
                                <li className='hover:animate-pulse text-lg inline-flex font-semibold leading-6 text-gray-600 hover:text-gray-500 border-b-2 transition duration-800  border-white hover:border-gray-400 '>
                                    <Link to="/joyas">Piedras</Link>
                                </li>
                            </ul>

          ...
          <Layout>
            ...
            <div className="flex justify-center items-center lg:flex-row   flex-col gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 ">{piedra && piedra.name}</h2>


                    <p className=" font-normal text-base leading-6 text-gray-600 mt-7"> {piedra && piedra.description }</p>
                    <p className=" font-semibold lg:text-2xl text-xl lg:leading-6 text-gray-800 leading-5 mt-6 ">${piedra && piedra.price}</p>
